...
const iframes = `<div class="container">
  <div class="monitor">
    <div class="monitorscreen">
      <iframe width="100%" height="425" src="https://www.youtube.com/embed/7vSptcbT_ds" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
  </div>
</div>`;
